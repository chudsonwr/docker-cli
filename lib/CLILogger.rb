...
class CLILogger
  ...
  def set_stream (stream)
    # If this is a new CLILogger, the log level will be unset.
  ...
  def initialize (level = 'INFO', stream = 'STDOUT')
    ...
    level = ENV['CLI_LOG_LEVEL'] unless ENV['CLI_LOG_LEVEL'].nil?
    set_level(level)
    set_format()
  end
...
# @clilog.info("This is an info log message")
# @clilog.debug("This is a debug log message")